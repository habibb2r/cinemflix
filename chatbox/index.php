...
<html lang="en">
   ...
   <body style="background-color: black;">
	<h1 style="background-color: black; color: Gold; text-align: center; margin-bottom:50px;"> Contact <span style="color:red;" >With</span> Admin</h1>
      <div class="container">
         <div class="row justify-content-md-center mb-4">
            <div class="col-md-6">
               <!--start code-->
               <div class="card">
                  <div class="card-body messages-box" style="background-color: rgb(0 123 255 / 50%);">
                  ...
                  <div class="card-header bg-info">
                    <div class="input-group">
					   ...
					   <input type="button" class="btn btn-danger" value="Send" onclick="send_msg()">
					   </span>
					</div> 
                  </div>
               </div>
			...
			if(txt){
				jQuery.ajax({
					...
					success:function(result){
						var html='<li class="messages-you clearfix"><span class="message-img"><img src="image/bott.png" class="avatar-sm rounded-circle"></span><div class="message-body clearfix"><div class="message-header"><strong class="messages-title">Admin</strong> <small class="time-messages text-muted"><span class="fas fa-time"></span> <span class="minutes">'+getCurrentTime()+'</span></small> </div><p class="messages-p">'+result+'</p></div></li>';
						jQuery('.messages-list').append(html);
